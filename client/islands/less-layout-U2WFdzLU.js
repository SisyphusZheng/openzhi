import{a as e,i as t,r as n}from"./island-api-consumer-DZ1zs91I.js";import{t as r}from"./design-tokens-B_ByjwIP.js";import{t as i}from"./src-DX1dVt7k.js";import"./less-theme-toggle-DXFiNDY8.js";var a=`less-layout`,o=class a extends i{static hydrateEvents=[{selector:`summary.mobile-menu-btn`,event:`click`,method:`_toggleMenu`}];static styles=[r,e`
      :host {
        display: block;
      }
      ...
      `];static properties={home:{type:Boolean,reflect:!0},currentPath:{type:String,attribute:`current-path`},navItems:{type:Array,attribute:`nav-items`},headerNav:{type:Array,attribute:`header-nav`},logoText:{type:String,attribute:`logo-text`},logoSub:{type:String,attribute:`logo-sub`},githubUrl:{type:String,attribute:`github-url`}};constructor(){super(),this.home=!1,this.currentPath=``,this.navItems=void 0,this.headerNav=void 0,this.logoText=`LessJS`,this.logoSub=``,this.githubUrl=`https://github.com/lessjs-run/LessJS`}render(){return this._dsdHydrated?n:this._renderLayout()}_renderLayout(){return t`
