...
| **修复** | `const url = this.apiUrl || 'https://less-demo-api.sisyphuszheng.deno.net/api'` |
| **状态** | ✅ 已修复 |
...
| **修复** | 改为三态：`let _lastNavType: 'push' | 'replace' | 'back' = 'back'` |
| **状态** | ✅ 已修复 |
...
| **问题** | 非项目控制域名，可下线/被攻破 |
| **修复** | api-consumer: `this.apiUrl || '/api'`；hero-ping 已在 B-3 中修复 |
| **状态** | ✅ 已修复 |
