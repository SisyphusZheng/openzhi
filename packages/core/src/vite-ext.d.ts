 ...
 *
 * This file extends the 'vite' module with a LessJS-specific route metadata key.
 ...
 *
 * NOTE: The __lessRouteMeta property is declared here but currently unused.
...
declare module 'vite' {
  interface IndexHtmlTransformContext {
    readonly __lessRouteMeta?: RouteMeta;
  }
}
